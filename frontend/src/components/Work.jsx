  ...
  return (
    <div name="work" className="w-full md:h-screen text-gray-300 bg-[#e1e1e1]">
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="mt-4">
          <ul className="grid grid-cols-1 gap-x-[65px] gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
            {project.map((item, index) => (
              <li className="group relative flex flex-col items-start">
                <div className="z-0 relative flex h-12 w-12 items-center justify-center rounded-full bg-white shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5">
                ...
                <p class="relative mt-6 flex text-sm font-medium text-zinc-400 transition group-hover:text-teal-500">
