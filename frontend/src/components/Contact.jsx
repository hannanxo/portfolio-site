...
const Contact = () => {
  return (
    <div method="POST" name="contact" className="w-full h-screen bg-[#e1e1e1] flex justify-center items-center p-4">
      <form action="" className="flex flex-col md:max-w-[600px] max-w-[400px] w-full pt-10 md:mt-10">
        ...
        <input className="bg-[#242424] p-2 rounded-lg" type="text" placeholder="Name" name="name" />
        <input className="my-4 p-2 bg-[#242424] rounded-lg" type="email" placeholder="Email" name="email" />
        <textarea className="bg-[#242424] p-2 rounded-lg" name="message" rows="10" placeholder="Message"></textarea>
